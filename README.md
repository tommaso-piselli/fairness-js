...
- To <b>Load</b> the graph: if you cloned the repository, you will find the JSONs in the `data/` subdirectory. Otherwise you can download [this](https://github.com/tommaso-piselli/tommaso-piselli.github.io/releases/download/untagged-e72f636e820402203351/random_JSON.zip) zip file.
